...
export default function createElement({
                                        ...
                                        useInlineStyles,
                                        key
                                      }: { node: any, stylesheet: any, style: any, useInlineStyles: any, key: any }) {
  const { properties, type, tagName: TagName, value } : {
    properties: any, type: string, tagName: any, value: string
  } = node;
